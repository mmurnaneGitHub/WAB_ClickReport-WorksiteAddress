...
define([
  ...
  //Contact information
  var contactInfo = "<div style='clear:both;'><p><b>Further Questions and Feedback:</b> <br> (253) 591-5306 <br> <a href='mailto:paidleave@cityoftacoma.org?subject=Paid Leave/Minimum Wage Map'>Email</a> <br> </p></div>";
  ...
  //Query layer - Zoning  
  var qtCOT = new QueryTask("https://gis.cityoftacoma.org/arcgis/rest/services/PDS/DARTgeneral/MapServer/0");  //City Boundary 
  var qCOT = new Query();
  ...
  var mjm_ClickReportFunctions = {
    ...
    handleQueryParcel: function (results) {
      ...
      if (parcel.length > 0) {
        ...
        var title = "City of Tacoma Address Verification";
          ...
          qtCOT.execute(qCOT, function (results) {
            ...
            if (results.features.length > 0) {
              ...
              arrayUtils.forEach(results.features, function (resultsRec) { //loop through all records (single or multiple)
                allowedUses += "<div style='float:left;'><b>Does this address qualify for Paid Leave or the City Minimum Wage?</b><br>Yes<br>&nbsp;</div>";
              });

              COT_Message += allowedUses;
            } else {
              COT_Message += "<div style='clear:both;'></div><div><br>Sorry, location is outside Tacoma City Limits.<br>&nbsp;</div>";
            }
            ...
            alert("Error in Tacoma Boundary identify: " + err.message);
            console.error("Identify Tacoma Boundary Error: " + err.message);
          });
